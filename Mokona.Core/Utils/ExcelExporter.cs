namespace Mokona.Core.Utils
{
    ...
    public class ExcelExporter
    {
        ...
        {
            var ds = new DataSet();
            ds.Tables.Add(CollectionToDataTable(list));

            return CreateExcelDocument(ds, xlsxFilePath);
        }

        public static bool CreateExcelDocument<T>(IEnumerable<T> list, Stream stream)
        {
            var ds = new DataSet();
            ds.Tables.Add(CollectionToDataTable(list));

            return CreateExcelDocument(ds, stream);
        }

        #region HELPER_FUNCTIONS
        private static DataTable CollectionToDataTable<T>(IEnumerable<T> list)
        {
        ...
        public static bool CreateExcelDocument(DataSet ds, Stream stream)
        {
            try
            {
